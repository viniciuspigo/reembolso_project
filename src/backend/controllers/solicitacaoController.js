const { createSolicitacao, getAllSolicitacoes } = require("../models/solicitacao");
...
const solicitacaoController = {
  async createSolicitacao(req, res) {
    ...
    try {
      ...
      await createSolicitacao(req.app.get("mysqlPool"), {
        email,
        nome,
        categoria,
        valor,
      ...
      console.error("Erro ao criar solicitação:", error.message, error.stack);
